...
if ratio <= 25:
    print('Не стоит рассчитывать на везение, ибо вы с ним явно не в ладах')
elif ratio <= 50:
    print('Безусловно в таких делах все можно решать бросая монетку, но ведь есть и другие способы...')
elif ratio <= 75:
    print('Вашей удаче не помешала бы немного помощи от хорошо продуманной стратегии...')
else:
